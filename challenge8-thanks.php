...
<body>
    <h1>Votre formulaire est valide !</h1>
    <p><?php echo "Merci $_POST[user_firstname] $_POST[user_lastname] de nous avoir contacté à propos de $_POST[user_messagetype]."?></p> 
